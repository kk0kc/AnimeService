$(function () {
    ...
    // var $tableLater = $('#animeListTableLater');
    //
    //
    // if ($tableLater.length) {
    //     var jsonUrl = '';
    //     if (window.categoryId == '') {
    //         jsonUrl = window.contextRoot + '/json/data/all/anime'
    //     } else {
                    ...
                    api
                        ...
                        .on(
                            ...
                            function () {
                                ...
                                var dMsg = (checked) ? 'You want to activate the Anime?'
                                    : 'You want to deactivate the Anime?';
                                var value = checkbox.prop('value');

                                bootbox
                                    .confirm({
                                        size: 'medium',
                                        title: 'Anime Activation & Deactivation',
                                        message: dMsg,
                                        callback: function (
                                            confirmed) {
                                            if (confirmed) {
