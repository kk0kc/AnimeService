        ...
        <div class="col-md-offset-2 col-md-8">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <sf:form class="form-horizontal" modelAttribute="anime"
                             action="/manage/anime" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" path="name" id="name"
                                          placeholder="Anime Name" class="form-control"/>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="description">
                                Anime Description : </label>

                            <div class="col-md-8">
                                <sf:textarea path="description" id="description" row="4"
                                             placeholder="Write a description of Anime"
                                             class="form-control"/>
